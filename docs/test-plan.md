...
| Mock/core unit | deterministic four-kind order; monotonic sequence; snapshot oldest-first cap at 100; publish order; independent subscribers; slow subscriber closed without affecting another |
